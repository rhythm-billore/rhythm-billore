...
| Project | Description |
|--------|-------------|
| [ltd_claim_incident_prediction](https://github.com/rhythm-billore/ltd-insurance-claim-prediction.git) | End-to-end ML application predicting long-term disability claim incident risk using XGBoost and SHAP interpretability, deployed via Streamlit Cloud for interactive risk assessment and explanation. |
